...
use crate::state::{
    WINDOW_WORKSPACES, WORKTREE_LOCKS,
    TERMINAL_STATES, TERMINAL_STATE_BROADCAST, LOCK_BROADCAST,
};
...
#[tauri::command]
pub(crate) fn set_window_workspace(window: tauri::Window, workspace_path: String) -> Result<(), String> {
...
#[tauri::command]
pub(crate) fn lock_worktree(window: tauri::Window, workspace_path: String, worktree_name: String) -> Result<(), String> {
...
#[tauri::command]
pub(crate) fn unlock_worktree(window: tauri::Window, workspace_path: String, worktree_name: String) {
...
#[tauri::command]
pub(crate) async fn open_workspace_window(app: tauri::AppHandle, workspace_path: String) -> Result<String, String> {
    let global = load_global_config();
    if !global.workspaces.iter().any(|w| w.path == workspace_path) {
        return Err("Workspace not found".to_string());
    }
