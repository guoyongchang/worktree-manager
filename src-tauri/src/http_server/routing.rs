...
use super::{
    ...
    h_auth_challenge, h_auth_verify, h_broadcast_terminal_state, h_cert_pem, h_check_dashscope_api_key,
    h_check_mirror_update, h_check_remote_branch_exists, h_check_worktree_status, h_clone_project,
    h_commit_all, h_create_pull_request, h_create_workspace, h_create_worktree,
    h_delete_archived_worktree, h_deploy_to_main, h_detect_tools, h_download_update_via_mirror,
    h_exit_main_occupation, h_fetch_project_remote, h_generate_commit_message, h_get_app_icon,
    h_get_app_version, h_get_branch_diff_stats, h_get_changed_files, h_get_commit_prefix_config,
    h_get_config_path_info, h_get_connected_clients, h_get_current_workspace, h_get_dashscope_api_key,
    ...
    h_pty_create, h_pty_exists, h_pty_read, h_pty_resize, h_pty_write, h_push_to_remote,
    h_remove_project_from_config, h_remove_workspace, h_restore_worktree, h_reveal_in_finder,
    h_save_workspace_config, h_save_workspace_config_by_path, h_scan_existing_projects,
    h_scan_linked_folders, h_set_commit_prefix_config, h_set_dashscope_api_key,
    h_set_dashscope_base_url, h_set_git_path, h_set_git_user_config, h_set_git_user_global_config,
    h_set_ngrok_token, h_set_voice_refine_enabled, h_set_window_workspace, h_start_ngrok_tunnel,
    h_start_sharing, h_stop_ngrok_tunnel, h_stop_sharing, h_switch_branch, h_switch_workspace,
...
pub(super) fn build_api_router(cert_pem: Option<String>) -> Router {
    let mut router = Router::new()
        ...
        .route("/api/check_dashscope_api_key", post(h_check_dashscope_api_key))
        .route("/api/get_commit_prefix_config", post(h_get_commit_prefix_config))
        ...
        .route("/api/set_git_user_global_config", post(h_set_git_user_global_config))
