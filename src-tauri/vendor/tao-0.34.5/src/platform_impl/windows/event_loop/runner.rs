...
// Tauri can clone and drop this handle from non-main threads through its
// unsafe-Send runtime context. Keep the runner main-thread-only, but make its
// ownership count atomic to avoid cross-thread refcount corruption and UAF.
